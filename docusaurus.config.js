...
const config = {
  ...
  projectName: 'CS639-Website', // Usually your repo name.
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/shuangshen19/CS639-Website',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        copyright: `Copyright © ${new Date().getFullYear()} Fall22 CS639-Final-Project. Built with Docusaurus.`,
      },
      prism: {
